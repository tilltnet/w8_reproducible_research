...
knitr::opts_chunk$set(
	...
	warning = FALSE,
	cache = FALSE,
	dev.args = list(type = "cairo") # Include this on windows machines in order to activate anti-alising for plots/ get better look plots
)
```
    
## Inline R-Code

In addtion to code chunks, R-Code can be integrated inline, into the Markdown parts of the document:

*Example:*

This is some text and then we show the mean of the cylinders in the mtcars dataset like this `` `r
mean(mtcars$cyl)` ``.

*Example rendered:*

This is some text and then we show the mean of the cylinders in the mtcars dataset like this `r mean(mtcars$cyl)`.
